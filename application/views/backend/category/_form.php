	...
	<div class="container">
		...
		<form class="form-horizontal" method="POST" action="<?php echo $form_action ?>">
		  	...
		  	<div class="control-group">
			    ...
			    <div class="controls">
			      	<input name = "category[name]" type="text" id="inputRealName" placeholder="" value = "<?php echo $category->name ?>">
			    </div>
		  	</div>
		  	 ...
		  	 <div class="control-group">
			    ...
			    <div class="controls">
			      	<textarea class="input-block-level" rows="7" name = "category[description]" type="text" id="inputUserName" placeholder="" value = "<?php echo $category->description ?>">
			    	</textarea>
			    </div>
		  	</div>
